...
void String::convertChars(char oldval, char newval)
{
...
void String::trim()
{
  ...
  String s(data);
  char *sp = s.data, *ep = s.data + s.length - 1;
...
bool String::containsDelimiters(const char* str)
{
  if (!str || !strlen(str))
    return false;
